      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="w-[calc(100vw-24px)] max-w-md mx-auto p-4 sm:p-6 rounded-xl">
          <DialogHeader className="mb-2">
            <DialogTitle className="text-lg sm:text-xl">Add Cash Payment</DialogTitle>
            <DialogDescription className="text-xs sm:text-sm">
              Record a cash payment for <span className="font-medium">{travellerName}</span>
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-4">
            <div className="space-y-1">
              <Label htmlFor="cp-amount" className="text-xs sm:text-sm">Amount (₹)</Label>
            ...
            <div className="space-y-1">
              <Label htmlFor="cp-date" className="text-xs sm:text-sm">Date</Label>
              <Input
                id="cp-date"
                type="date"
                value={date}
            ...
            <div className="space-y-1">
              <Label htmlFor="cp-note" className="text-xs sm:text-sm">Note (optional)</Label>
              <Input
                id="cp-note"
                type="text"

      ...
      <DialogContent className="w-[calc(100vw-24px)] max-w-md mx-auto p-4 sm:p-6 rounded-xl">
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <Label htmlFor="ece-category" className="text-xs sm:text-sm">Category</Label>
            <Input
              id="ece-category"
              type="text"
              value={category}
          ...
          <div className="space-y-1">
            <Label htmlFor="ece-amount" className="text-xs sm:text-sm">Amount (₹)</Label>
          ...
          <div className="space-y-1">
            <Label htmlFor="ece-date" className="text-xs sm:text-sm">Date</Label>
            <Input
              id="ece-date"
              type="date"
              value={date}
          ...
          <div className="space-y-1">
            <Label htmlFor="ece-note" className="text-xs sm:text-sm">Note (optional)</Label>
            <Input
              id="ece-note"
              type="text"

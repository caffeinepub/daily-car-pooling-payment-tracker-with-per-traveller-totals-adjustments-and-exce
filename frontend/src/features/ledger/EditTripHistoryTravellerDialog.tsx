    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100vw-24px)] max-w-sm mx-auto p-4 sm:p-6 rounded-xl">
        <DialogHeader className="mb-2">
          <DialogTitle className="text-lg sm:text-xl">Edit Trip Entry</DialogTitle>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <Label htmlFor="eth-date" className="text-xs sm:text-sm">Date</Label>
            <Input
              id="eth-date"
              type="date"
              value={dateKey}
          ...
          <div className="space-y-2">
            <Label className="text-xs sm:text-sm">Trip Sessions</Label>

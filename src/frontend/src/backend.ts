...
export class Backend implements backendInterface {
    ...
    async getAllBalances(): Promise<Array<[Principal, Amount]>> {
        if (this.processError) {
            try {
    ...
    async getBalance(arg0: Principal): Promise<Amount> {
        if (this.processError) {
            try {
    ...
    async recordPayment(arg0: Date_, arg1: Amount, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordPayment(arg0, arg1, to_candid_opt_n6(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startCharge(arg0: string, arg1: Amount, arg2: Array<Principal>): Promise<void> {
        if (this.processError) {
            try {

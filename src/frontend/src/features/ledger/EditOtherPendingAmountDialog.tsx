      ...
      <DialogContent className="w-[calc(100vw-24px)] max-w-md mx-auto p-4 sm:p-6 rounded-xl">
        <DialogHeader className="mb-2">
          <DialogTitle className="text-lg sm:text-xl">
            Edit Other Pending Amount
          </DialogTitle>
          <DialogDescription className="text-xs sm:text-sm">
            Editing pending amount for{" "}
        ...
        <div className="space-y-4">
          ...
          {/* Amount */}
          <div className="space-y-1">
            <Label htmlFor="edit-op-amount" className="text-xs sm:text-sm">
              Amount (₹)
            </Label>
          ...
          {/* Date */}
          <div className="space-y-1">
            <Label htmlFor="edit-op-date" className="text-xs sm:text-sm">
              Date
            </Label>
            <Input
              id="edit-op-date"
          ...
          {/* Comment */}
          <div className="space-y-1">
            <Label htmlFor="edit-op-comment" className="text-xs sm:text-sm">
              Comment (optional)
            </Label>
            <Input
              id="edit-op-comment"
